...
const TvDetails = () => {
  ...
  return info ? (
    ...
    >
      {/* part 1 navigation */}
      <nav className="w-full fixed top-0 flex gap-8 px-28 text-xl h-[7vh] items-center bg-[linear-gradient(rgba(0,0,0,.2),rgba(0,0,0,.6),rgba(0,0,0,.8))]">
        <Link
          onClick={() => navigate(-1)}
      ...
      <div className="w-full md:px-28  p-7 py-5 md:flex ">
        <img
          className="shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)] flex md:h-[60vh] object-cover rounded"
      ...
      <div className="w-5/6  md:px-28 px-8 ">
        <div className="mt-5 gap-5 p-2 flex flex-col  ">
      ...
      <hr className="md:mx-28 mx-7 mt-10 mb-5 border-none h-[2px] bg-zinc-500" />
      {/* part 4 sessions  */}
      <h1 className="md:px-28 px-10 text-2xl font-semibold ">
        Seeasons
      </h1>
      <div className="md:px-28 px-8 w-full flex overflow-y-hidden mb-5 ">
        {
          info.detail.seasons.map((s,i)=>(
            <div key={i} className="md:w-[28vh] w-[36vh] m-2 " >
            <img
            
            className="shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)] flex md:w-[15vw] md:h-[40vh] object-cover rounded"
            src={`https://image.tmdb.org/t/p/original/${
              s.poster_path }`}
            alt=""
          />
      ...
      <h1 className="md:px-28 px-8 text-2xl font-semibold ">
